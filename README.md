...
- **Онлайн-статус собеседника** в личном чате: presence-реестр в Redis (учитывает несколько вкладок), снимок «кто онлайн» при подключении; presence и `last_seen` ведёт именно личный канал, поэтому закрытие чата не «выключает» пользователя
