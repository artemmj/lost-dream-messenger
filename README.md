...
- Авто-reconnect при разрыве соединения (фиксированная задержка 2 c) с перечитыванием истории: сообщения, пришедшие пока сокет был разорван, добираются через REST
